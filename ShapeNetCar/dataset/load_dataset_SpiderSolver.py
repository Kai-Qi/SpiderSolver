import os
from dataset.dataset_SpiderSolver import get_datalist
...
def load_train_val_fold(args, preprocessed, onion_num = 15, surf_clustering_num = 6):
    ...
    train_dataset, coef_norm = get_datalist(args.data_dir, trainlst, norm=True, savedir=args.save_dir,
                                            preprocessed=preprocessed, onion_num =  onion_num, surf_clustering_num = surf_clustering_num)
