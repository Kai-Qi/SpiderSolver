...
if __name__ == '__main__':
    ...
    root = '/data/qikai/Transolver-main/data/mlcfd_data/training_data'
    save_path = '/data/qikai/Transolver-main/data/mlcfd_data/preprocessed_data/param0/' + file_name
    ...
    velo = vtk_to_numpy(unstructured_grid_data_velo.GetPointData().GetVectors())   # 29498*3
    press = vtk_to_numpy(unstructured_grid_data_press.GetPointData().GetScalars())  # 3682
    points_velo = vtk_to_numpy(unstructured_grid_data_velo.GetPoints().GetData())  # 29498*3
    points_press = vtk_to_numpy(unstructured_grid_data_press.GetPoints().GetData())  # 3682*3
