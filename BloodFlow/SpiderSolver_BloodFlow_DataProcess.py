...
def SpiderSolver_BloodFlow_DataProcess(points, n_clusters, onion_num, sava_path):
    ...
    #     save_template_SpectralClustering= io.loadmat(evaluation_path + "/template.mat")
    #     point_surface_dataset = save_template_SpectralClustering["template"]
    ...
    if sava_path != "":
        io.savemat(sava_path + 'BloodFlow_DataProcess.mat', 
        {'surf': surf.numpy(), 'onion_index': onion_index.numpy(),
         'onion_index_0': onion_index_0.numpy(), 'velo_cluster_index_one_hot': velo_cluster_index_one_hot.numpy(),
         'labels_SpectralClustering': labels_SpectralClustering})
